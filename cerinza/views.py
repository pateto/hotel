...
ROOMS = [
	...
	},
	{
		...
		'slug': 'cobagote',
		'capacidad': 6,
		'descripcion': '2 camas dobles, 1 camarote',
		'descripcion_en': '2 double beds, 1 bunk bed',
		'media_folder': 'cobagote',
		'photos': ['0.jpeg', '00.jpeg'],
	...
	},
	{
		...
		'descripcion': '2 camas dobles',
		'descripcion_en': '2 double beds',
		'media_folder': 'el_hato',
		'photos': ['0.jpeg'],
		'detalle': 'El Hato es una vereda conocida por su ambiente tranquilo y sus paisajes rurales. La habitación que lleva su nombre ofrece una experiencia acogedora, ideal para quienes buscan descansar y disfrutar de la autenticidad del campo boyacense.',
		'detalle_en': "El Hato is a rural area known for its peaceful environment and scenic landscapes. The room named after it offers a cozy experience, ideal for those seeking rest and to enjoy the authenticity of the Boyacá countryside."
	},
	{
		'name': 'La Meseta',
		'name_en': 'La Meseta',
		...
		'descripcion': '2 camas dobles',
		'descripcion_en': '2 double beds',
		'media_folder': 'la_meseta',
		'photos': ['0.jpeg'],
		'detalle': 'La Meseta es una vereda que se extiende sobre una amplia planicie, con horizontes abiertos y esa sensación de libertad propia de los altiplanos boyacenses. La habitación que lleva su nombre invita a descansar en un entorno sereno, donde el silencio del campo y la amplitud del paisaje crean una experiencia única.',
		'detalle_en': "La Meseta is a rural area that stretches across a broad plateau, offering open horizons and the sense of freedom that defines the Boyacá highlands. The room named after it invites guests to unwind in a serene setting, where the stillness of the countryside and the vastness of the landscape create a truly unique experience."
	},
]
